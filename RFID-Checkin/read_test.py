...
def get_active_tags():
    ...
    while not active_tags:
        active_tags.extend(addTags([test(b'E2002047381502180820C296'), test(b'0000000000000000C0002403')], "in"))
        active_tags.extend(addTags([test(b'E2002047381502180820C296'), test(b'0000000000000000C0002403')], "out"))
